...
curl -L -o ./LEOGLLRD/graphdb.zip https://github.com/LEOGLLRD/GraphDB-Docker/archive/refs/heads/2-services-dockercompose.zip
...
docker cp ./generated/graphdb-project temporary:/shared-volume/
echo "Files copied !"
docker rm temporary
...
docker compose -f ./LEOGLLRD-graphdb/GraphDB-Docker-2-services-dockercompose/docker-compose.yml up
